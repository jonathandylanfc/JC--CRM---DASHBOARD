...
import { LayoutDashboard, CheckSquare, DollarSign, PiggyBank, Settings, BarChart2, CalendarDays } from "lucide-react"
...
const ALL_TABS = [
  ...
  { icon: CalendarDays,    label: "Calendar", href: "/calendar",    investmentsOnly: false },
