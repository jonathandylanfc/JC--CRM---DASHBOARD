...
// FIFA/Coca-Cola World Ranking — exact values from fifa.com (Jun 23 2026)
const STATIC_RANKINGS = [
  ...
  { rank: 5,   prevRank: 5,   name: "Brazil",                short: "BRA", flag: FLAG("bra"), confederation: "CONMEBOL", points: 1772.01 },
  { rank: 6,   prevRank: 6,   name: "Morocco",               short: "MAR", flag: FLAG("mar"), confederation: "CAF",      points: 1769.98 },
  { rank: 7,   prevRank: 7,   name: "Netherlands",           short: "NED", flag: FLAG("ned"), confederation: "UEFA",     points: 1764.40 },
  { rank: 8,   prevRank: 8,   name: "Germany",               short: "GER", flag: FLAG("ger"), confederation: "UEFA",     points: 1760.46 },
  { rank: 9,   prevRank: 9,   name: "Portugal",              short: "POR", flag: FLAG("por"), confederation: "UEFA",     points: 1755.09 },
  { rank: 10,  prevRank: 10,  name: "Belgium",               short: "BEL", flag: FLAG("bel"), confederation: "UEFA",     points: 1727.88 },
  { rank: 11,  prevRank: 11,  name: "Mexico",                short: "MEX", flag: FLAG("mex"), confederation: "CONCACAF", points: 1721.78 },
  { rank: 12,  prevRank: 12,  name: "Colombia",              short: "COL", flag: FLAG("col"), confederation: "CONMEBOL", points: 1712.60 },
  { rank: 13,  prevRank: 13,  name: "USA",                   short: "USA", flag: FLAG("usa"), confederation: "CONCACAF", points: 1709.59 },
  { rank: 14,  prevRank: 14,  name: "Italy",                 short: "ITA", flag: FLAG("ita"), confederation: "UEFA",     points: 1704.73 },
  { rank: 15,  prevRank: 15,  name: "Croatia",               short: "CRO", flag: FLAG("cro"), confederation: "UEFA",     points: 1695.21 },
  { rank: 16,  prevRank: 16,  name: "Japan",                 short: "JPN", flag: FLAG("jpn"), confederation: "AFC",      points: 1681.26 },
  { rank: 17,  prevRank: 18,  name: "Switzerland",           short: "SUI", flag: FLAG("sui"), confederation: "UEFA",     points: 1654.94 },
  { rank: 18,  prevRank: 19,  name: "Uruguay",               short: "URU", flag: FLAG("uru"), confederation: "CONMEBOL", points: 1649.96 },
  { rank: 19,  prevRank: 17,  name: "Senegal",               short: "SEN", flag: FLAG("sen"), confederation: "CAF",      points: 1638.36 },
  { rank: 20,  prevRank: 20,  name: "Denmark",               short: "DEN", flag: FLAG("den"), confederation: "UEFA",     points: 1619.47 },
  { rank: 21,  prevRank: 22,  name: "IR Iran",               short: "IRN", flag: FLAG("irn"), confederation: "AFC",      points: 1611.18 },
  { rank: 22,  prevRank: 27,  name: "Norway",                short: "NOR", flag: FLAG("nor"), confederation: "UEFA",     points: 1606.48 },
  { rank: 23,  prevRank: 21,  name: "Austria",               short: "AUT", flag: FLAG("aut"), confederation: "UEFA",     points: 1599.99 },
  { rank: 24,  prevRank: 23,  name: "Korea Republic",        short: "KOR", flag: FLAG("kor"), confederation: "AFC",      points: 1591.75 },
  { rank: 25,  prevRank: 24,  name: "Nigeria",               short: "NGA", flag: FLAG("nga"), confederation: "CAF",      points: 1585.02 },
  { rank: 26,  prevRank: 25,  name: "Australia",             short: "AUS", flag: FLAG("aus"), confederation: "AFC",      points: 1584.55 },
  { rank: 27,  prevRank: 26,  name: "Egypt",                 short: "EGY", flag: FLAG("egy"), confederation: "CAF",      points: 1583.37 },
  { rank: 28,  prevRank: 29,  name: "Algeria",               short: "ALG", flag: FLAG("alg"), confederation: "CAF",      points: 1575.64 },
  { rank: 29,  prevRank: 28,  name: "Canada",                short: "CAN", flag: FLAG("can"), confederation: "CONCACAF", points: 1572.13 },
  { rank: 30,  prevRank: 30,  name: "Ecuador",               short: "ECU", flag: FLAG("ecu"), confederation: "CONMEBOL", points: 1558.35 },
  { rank: 31,  prevRank: 31,  name: "Côte d'Ivoire",         short: "CIV", flag: FLAG("civ"), confederation: "CAF",      points: 1551.71 },
  ...
  { rank: 40,  prevRank: 40,  name: "Panama",                short: "PAN", flag: FLAG("pan"), confederation: "CONCACAF", points: 1505.33 },
  { rank: 41,  prevRank: 41,  name: "Scotland",              short: "SCO", flag: FLAG("sco"), confederation: "UEFA",     points: 1504.41 },
  { rank: 42,  prevRank: 42,  name: "Serbia",                short: "SRB", flag: FLAG("srb"), confederation: "UEFA",     points: 1502.13 },
  { rank: 43,  prevRank: 43,  name: "Congo DR",              short: "COD", flag: FLAG("cod"), confederation: "CAF",      points: 1487.18 },
  { rank: 44,  prevRank: 44,  name: "Czechia",               short: "CZE", flag: FLAG("cze"), confederation: "UEFA",     points: 1481.49 },
  { rank: 45,  prevRank: 45,  name: "Cameroon",              short: "CMR", flag: FLAG("cmr"), confederation: "CAF",      points: 1481.24 },
  { rank: 46,  prevRank: 46,  name: "Slovakia",              short: "SVK", flag: FLAG("svk"), confederation: "UEFA",     points: 1473.66 },
  { rank: 47,  prevRank: 47,  name: "Greece",                short: "GRE", flag: FLAG("gre"), confederation: "UEFA",     points: 1473.19 },
  ...
  { rank: 54,  prevRank: 54,  name: "Uzbekistan",            short: "UZB", flag: FLAG("uzb"), confederation: "AFC",      points: 1444.48 },
  { rank: 55,  prevRank: 55,  name: "Republic of Ireland",   short: "IRL", flag: FLAG("irl"), confederation: "UEFA",     points: 1441.10 },
  { rank: 56,  prevRank: 56,  name: "Slovenia",              short: "SVN", flag: FLAG("svn"), confederation: "UEFA",     points: 1441.09 },
  { rank: 57,  prevRank: 57,  name: "Qatar",                 short: "QAT", flag: FLAG("qat"), confederation: "AFC",      points: 1438.82 },
  { rank: 58,  prevRank: 58,  name: "Tunisia",               short: "TUN", flag: FLAG("tun"), confederation: "CAF",      points: 1437.69 },
  { rank: 59,  prevRank: 59,  name: "Saudi Arabia",          short: "KSA", flag: FLAG("ksa"), confederation: "AFC",      points: 1426.71 },
  { rank: 60,  prevRank: 60,  name: "Iraq",                  short: "IRQ", flag: FLAG("irq"), confederation: "AFC",      points: 1419.24 },
  { rank: 61,  prevRank: 61,  name: "South Africa",          short: "RSA", flag: FLAG("rsa"), confederation: "CAF",      points: 1418.21 },
  { rank: 62,  prevRank: 62,  name: "Burkina Faso",          short: "BFA", flag: FLAG("bfa"), confederation: "CAF",      points: 1406.99 },
  { rank: 63,  prevRank: 63,  name: "Cabo Verde",            short: "CPV", flag: FLAG("cpv"), confederation: "CAF",      points: 1401.77 },
  { rank: 64,  prevRank: 64,  name: "Bosnia and Herzegovina",short: "BIH", flag: FLAG("bih"), confederation: "UEFA",     points: 1381.18 },
  { rank: 65,  prevRank: 65,  name: "Ghana",                 short: "GHA", flag: FLAG("gha"), confederation: "CAF",      points: 1380.71 },
  ...
  { rank: 68,  prevRank: 69,  name: "United Arab Emirates",  short: "UAE", flag: FLAG("uae"), confederation: "AFC",      points: 1370.47 },
  { rank: 69,  prevRank: 70,  name: "North Macedonia",       short: "MKD", flag: FLAG("mkd"), confederation: "UEFA",     points: 1369.16 },
  { rank: 70,  prevRank: 71,  name: "Northern Ireland",      short: "NIR", flag: FLAG("nir"), confederation: "UEFA",     points: 1365.30 },
  { rank: 71,  prevRank: 72,  name: "Jamaica",               short: "JAM", flag: FLAG("jam"), confederation: "CONCACAF", points: 1357.84 },
  { rank: 72,  prevRank: 68,  name: "Jordan",                short: "JOR", flag: FLAG("jor"), confederation: "AFC",      points: 1355.89 },
  ...
  { rank: 87,  prevRank: 87,  name: "Haiti",                 short: "HAI", flag: FLAG("hai"), confederation: "CONCACAF", points: 1271.00 },
