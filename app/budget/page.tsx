...
export default async function BudgetPage({
  ...
  const [categories, financeSummary, expensesByCategory, monthlyTransactions, lastMonthExpenses, savingsGoals, accountGrowth, connectedBankNames, user] = await Promise.all([
    getBudgetCategories(),
